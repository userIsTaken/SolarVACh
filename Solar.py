...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_16.setGeometry(QtCore.QRect(420, 20, 101, 17))
        self.label_16.setAlignment(QtCore.Qt.AlignCenter)
        self.label_16.setObjectName("label_16")
        self.save_slot = QtWidgets.QTextEdit(self.frame)
        self.save_slot.setGeometry(QtCore.QRect(340, 40, 271, 21))
        ...
        self.power_graph = PlotWidget(self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label.setGeometry(QtCore.QRect(40, 0, 241, 31))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(40, 20, 54, 17))
        self.label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.frame_3)
        self.label_3.setGeometry(QtCore.QRect(40, 80, 54, 17))
        ...
        self.label_6.setGeometry(QtCore.QRect(40, 0, 241, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_7.setGeometry(QtCore.QRect(10, 20, 141, 17))
        self.label_7.setAlignment(QtCore.Qt.AlignCenter)
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(self.frame_4)
        self.label_8.setGeometry(QtCore.QRect(50, 80, 54, 17))
        self.label_8.setAlignment(QtCore.Qt.AlignCenter)
        self.label_8.setObjectName("label_8")
        self.label_9 = QtWidgets.QLabel(self.frame_4)
        self.label_9.setGeometry(QtCore.QRect(190, 50, 141, 17))
        self.label_9.setAlignment(QtCore.Qt.AlignCenter)
        self.label_9.setWordWrap(False)
        self.label_9.setObjectName("label_9")
        self.array_size_box = QtWidgets.QSpinBox(self.frame_4)
        self.array_size_box.setGeometry(QtCore.QRect(30, 40, 91, 27))
        self.array_size_box.setObjectName("array_size_box")
        self.wait_box = QtWidgets.QSpinBox(self.frame_4)
        self.wait_box.setGeometry(QtCore.QRect(30, 100, 91, 27))
        self.wait_box.setObjectName("wait_box")
        self.x_mean_box = QtWidgets.QDoubleSpinBox(self.frame_4)
        self.x_mean_box.setGeometry(QtCore.QRect(220, 70, 91, 27))
        ...
        self.density_graph = PlotWidget(self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_16.setText(_translate("MainWindow", "Save to path:"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "VACh"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Time functions"))
