...
def get_previous_values():
    ...
    section="VALUES"
    cp.read(cfpath)
    startV, endV, points, array_size, idx, nplc, area = None, None, None, None, None, None, None
    try:
        ...
        area = cp[section]['area']
    except Exception as ex:
        print('ERR:CONF:00B')
        print(str(ex))
        pass
    return startV, endV, points, array_size, idx, nplc, area
    pass
